...
export default function BookingModal({ car, onClose, lang, onCarChange }: BookingModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (routeCategory === 'sewa_armada') routeText = 'Sewa Rental Armada Only';

    const textTemplate = `Halo CV. Anugrah Pariwisata, saya ingin berkonsultasi & melakukan reservasi tour:
