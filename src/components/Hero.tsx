...
import { Compass, ShieldCheck, ArrowRight, MessageCircle, Bus, Award, Sparkles, Building2, Users } from 'lucide-react';
...
export default function Hero({ onExploreClick, lang, onBookingClick }: HeroProps) {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = 'Halo CV. Anugrah Pariwisata, saya berminat berkonsultasi mengenai paket gathering, outbound, tour & rental armada. Mohon penawaran harga terbaik. Terima kasih!';
  ...
  return (
    <section id="home" className="relative pt-24 sm:pt-28 pb-16 bg-white overflow-hidden text-left">
      ...
      {/* 1. HERO MAIN BANNER (Exact Raja-Wisata Corporate Services Style) */}
      <div className="relative w-full min-h-[520px] sm:min-h-[580px] flex items-center justify-center bg-slate-950 text-white overflow-hidden border-b border-slate-200">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16 text-center space-y-6">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4.5 py-1.5 rounded-full bg-orange-600/90 border border-orange-400/50 text-white font-sans font-extrabold text-xs tracking-wider uppercase shadow-md"
          >
            <Award className="w-4 h-4 text-amber-300 shrink-0" />
            <span>CV. ANUGRAH PARIWISATA • WISATA HEMAT BERSAMA TRAVEL HEBAT</span>
          </motion.div>

          {/* Main Headline (Exact Raja-Wisata Corporate Services Style) */}
          <motion.h1 
          ...
          {/* Subheadline (Italic Clean Sans Font) */}
          <motion.p
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="font-sans text-slate-200 text-base sm:text-xl italic leading-relaxed max-w-3xl mx-auto font-medium"
          >
            Tingkatkan semangat tim dengan pengalaman tak terlupakan di destinasi terbaik bersama CV. Anugrah Pariwisata!
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>Konsultasi Corporate Tour WA</span>
      ...
      {/* 2. VIBRANT ORANGE TRANSPORT RENT BANNER (Raja-Wisata Style) */}
