      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-8 border border-slate-700/80 shadow-2xl mb-14 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-8 text-left space-y-2">
            <span className="text-[10px] font-extrabold uppercase tracking-widest text-orange-400 bg-orange-950/80 px-3 py-1 rounded-full border border-orange-800/50">
          ...
          <div className="md:col-span-4 flex justify-start md:justify-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-gradient-to-r from-orange-600 via-amber-600 to-orange-500 hover:from-orange-700 hover:to-amber-700 text-white font-sans font-bold text-xs uppercase px-7 py-4 rounded-full shadow-lg shadow-orange-600/25 transition-all flex items-center gap-2.5 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 text-left border-b border-slate-800/80 pb-12">
          ...
          <div className="md:col-span-5 space-y-5">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-orange-600 to-amber-600 flex items-center justify-center text-white font-black font-display text-xl shadow-lg shadow-orange-600/20 shrink-0">
                AP
              </div>
              <div>
                <span className="font-display font-black text-xl tracking-tight text-white uppercase block">
                  CV. ANUGRAH <span className="text-orange-500">PARIWISATA</span>
                </span>
                <span className="font-sans text-[10px] font-bold text-orange-400 tracking-wider block mt-0.5">
            ...
            <div className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
              <span className="text-[10px] font-extrabold text-orange-400 uppercase tracking-wider block">MOTTO PERUSAHAAN</span>
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className="font-display font-black text-sm uppercase text-orange-500 tracking-wider">
              Alamat Kantor Resmi
            </h4>
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="space-y-2 text-xs text-slate-400 font-medium">
              <button
                ...
                className="block hover:text-orange-400 transition-colors text-left"
              >
                ➔ Beranda Utama
              </button>
              <button
